class GuestListsController < ApplicationController
  ...
  def create
    ...
    # @guest_list = current_user.guest_list.build(:guest_id => params[:guest_id])
  ...
  def destroy
    # @guest_list = current_user.guest_lists.find(params[:id])
    @guest_list.destroy
    respond_to do |format|
  ...
  private
    ...
    def guest_list_params
      params.require(:guest_list).permit(:user_id, :guest_id, :week_id)
    end
end
